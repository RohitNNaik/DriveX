...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full glass border-b border-slate-200/60 shadow-sm">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden md:flex items-center gap-2">
          {selected.length > 0 && (
            <Link
              href="/compare"
              className="flex items-center gap-1.5 rounded-full bg-emerald-500 px-3.5 py-1.5 text-xs font-bold text-white shadow-md shadow-emerald-500/30 hover:bg-emerald-600 transition-all hover:shadow-emerald-500/50"
            >
          ...
          <Link
            href="/ai-advisor"
            className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2 text-sm font-bold text-white shadow-md shadow-blue-500/30 hover:from-blue-700 hover:to-blue-800 transition-all hover:shadow-blue-500/50"
          >
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden border-t border-slate-100 bg-white/95 backdrop-blur px-4 pb-5">
