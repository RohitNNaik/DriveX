    ...
    async scrapeAllBrands() {
        ...
        try {
            ...
            if (allResults.length > 0) {
                await ScrapedCarPrice_1.default.insertMany(allResults.map((item) => ({
                    ...item,
                    scrapedAt: new Date(),
                    staticData: false,
                })));
...
exports.default = new CarScraper();
//# sourceMappingURL=carScraper.js.map