...
const ScrapedCarPrice_1 = __importDefault(require("./src/models/ScrapedCarPrice"));
...
async function seedStaticData() {
    try {
        ...
        await ScrapedCarPrice_1.default.deleteMany({ staticData: true });
        ...
        const result = await ScrapedCarPrice_1.default.insertMany(staticDataWithMetadata);
...
seedStaticData();
//# sourceMappingURL=seed-static-data.js.map